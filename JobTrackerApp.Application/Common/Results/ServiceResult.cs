...
namespace JobTrackerApp.Application.Common.Results;
...
public class ServiceResult<T>
{
    ...
    {
        return new ServiceResult<T> { ErrorMessage = new List<string> { errorMessage }, Status = status };
    }
}
...
public class ServiceResult
{
    ...
    {
        return new ServiceResult { ErrorMessage = new List<string> { errorMessage }, Status = status };
    }
}
